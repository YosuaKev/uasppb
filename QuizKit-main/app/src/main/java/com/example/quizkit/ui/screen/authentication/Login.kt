...
fun LoginScreen(navController: NavController, authViewModel: AuthViewModel = koinViewModel()) {
    ...
    Scaffold(
        ...
        containerColor = Color(0xFFFFD180), // Warna latar belakang oranye terang dengan kode HEX
        ...
        Column(
            ...
            Button(
                ...
                colors = ButtonDefaults.buttonColors(
                    containerColor = Color(0xFFBF360C), // Warna tombol oranye gelap dengan kode HEX
            ...
            Text(
                buildAnnotatedString {
                    withStyle(
                        style = SpanStyle(
                            color = Color.Black // Warna teks tautan putih
                        )
                    ) {
                    ...
                    withStyle(
                        style = SpanStyle(
                            color = Color(0xFFBF360C), // Warna teks tautan putih
